...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function onScanSuccess(decodedText) {
    ...
    try {
      const registroEncontrado = await ConcesionariaAPI.obtenerPorQR(datosDelQR.numAutorizado);
      ...
      if (campoLocalidad)   campoLocalidad.value   = "C";
      if (campoAutorizado)  campoAutorizado.value  = registroEncontrado.autorizado;
      if (campoHorario)     campoHorario.value     = registroEncontrado.horario_atencion;
